    ...
    <Modal isOpen={isOpen} onClose={onClose} showClose={showClose}>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center mb-6">
          ...
          <div className="mb-4 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              <ExclamationTriangleIcon className="h-5 w-5 text-gray-600 dark:text-gray-400 mt-1 flex-shrink-0" />
          ...
          <div className="mb-6 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              <InformationCircleIcon className="h-5 w-5 text-gray-600 dark:text-gray-400 mt-1 flex-shrink-0" />
              <div className="text-sm text-left pt-1">
